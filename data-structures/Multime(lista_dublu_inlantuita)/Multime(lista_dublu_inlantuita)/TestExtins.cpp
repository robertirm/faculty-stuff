...
void testAllExtins() {
	testCreeaza();
	std::cout << "Finalizare testCreeaza() !\n";
	testAdauga();
	std::cout << "Finalizare testAdauga() !\n";
	testSterge();
	std::cout << "Finalizare testSterge() !\n";
	testIterator();
	std::cout << "Finalizare testIterator() !\n";
	testQuantity();
	std::cout << "Finalizare testQuantity() !\n";
